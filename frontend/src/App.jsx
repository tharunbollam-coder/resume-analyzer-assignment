    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <h1 className="text-2xl md:text-4xl font-extrabold text-blue-700 tracking-tight">
            Resume Analyzer
          </h1>
        ...
        <div className="w-full">
          {activeTab === "live" && (
            <div>
              ...
              />
              {loading && (
                <div className="mt-8 text-center text-lg text-gray-600 animate-pulse">
                  Analyzing your resume...
                </div>
              )}
              {error && (
                <div className="mt-8 text-center text-lg text-red-500 animate-shake">
                  {error}
                </div>
              )}
